package com.hyeyeong.study.common.util.file.zip;

import com.hyeyeoung.study.common.util.file.zip.ZipUtils;
...
public class ZipUtilsTest {
    ...
    private ZipDto createZipDto(String fileName) {
        try {
            String filePath = "com/hyeyeong/study/common/util/file/zip/" + fileName;
