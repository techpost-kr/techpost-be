package com.techpost.common.util.file.zip;

import com.techpost.common.util.file.zip.dto.ZipDto;
...
public class ZipUtilsTest {
    ...
    private ZipDto createZipDto(String fileName) {
        try {
            String filePath = "com/techpost/common/util/file/zip/" + fileName;
